...
class BmcItsm7TaskCreateDetailedV1
  ...
  def initialize(input)
    ...
    preinitialize_on_first_load(
      @input_document,
      ['TMS:Task', 'TMS:Association', 'TMS:FlowBuilder']
    )
    ...
    log(format_hash("TMS:Task Field Values:", @task_field_values))
  ...
  def execute
    ...
    log(format_hash("TMS:FlowBuilder Field Values:", @flow_builder_field_values)) if @debug_logging_enabled
